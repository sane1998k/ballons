...
var oldvalue = document.getElementById("nameselect2").value;
var newvalue;

var oldvalue2 = document.getElementById("num").value;
var newvalue2;

var inputBox = document.getElementById("nameselect2");
...
$('input[name=update]').click( 
    ...
    // newvalue = document.getElementById("nameselect2").value;
    // oldvalue = newvalue;
        })
    ...
    $('input[name=num]').keyup (
      function() {
            alert(oldvalue2);
    newvalue2 = document.getElementById("num").value;
      })
